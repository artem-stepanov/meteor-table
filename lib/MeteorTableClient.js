...
Template.meteorTable.onCreated(function () {
    ...
    var selectorFilters = new ReactiveVar(db.selectorFilters || {});
...
Template.meteorTable.events({
    ...
    'click .meteor-table-filters .meteor-table-submit': function (e) {
        ...
        var selectorFilters = MeteorTable.getSelectors({}, Template.instance().filters.get(), dataFilters, Template.instance().dateFormatMoment);
        ...
        updateDbData("selectorFilters", selectorFilters);
        resetCheckboxChecked.call(this, Template.instance());
    },
