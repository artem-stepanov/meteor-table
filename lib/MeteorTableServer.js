...
var getParams = function (columns, limit, skip, sort, sortOrder) {
...
MeteorTable.publish = function (name, collectionOrFunction, selectorOrFunction) {

    Meteor.publish("meteor-table-" + name, function (columns, limit, skip, sort, sortOrder, filters, dataFilters, dateFormatMoment) {
        ...
        var params = getParams(columns, limit, skip, sort, sortOrder);
    ...
    Meteor.methods({
        ...
        meteorTableDownloadExcelFile: function (fieldsExcel, columnsOrderExcel, shownColumnsExcel, limitExcel, skipExcel, sortExcel, sortOrderExcel, filtersExcel, dataFiltersExcel, dateFormatMomentExcel) {
            ...
            var params = getParams(shownColumnsExcel, limitExcel, skipExcel, sortExcel, sortOrderExcel);
            params.limit = 0;
            params.skip = 0;
            ...
            collection.find(selector, params).forEach(function (dataRow) {
                ...
                _.each(shownColumnsExcel, function (column) {
                    ...
                    var cellValue = getExcelValue(fieldValue, type, options);
            ...
            workbook.addSheet(i18n("shipments.name"), worksheet); // Add the worksheet to the workbook
