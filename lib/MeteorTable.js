...
MeteorTableParams.METEOR_TABLE_FIELD_TYPE_STRING = 1;
MeteorTableParams.METEOR_TABLE_FIELD_TYPE_TEXT = 2;
MeteorTableParams.METEOR_TABLE_FIELD_TYPE_DATE = 3;
MeteorTableParams.METEOR_TABLE_FIELD_TYPE_SELECT = 4;
...
MeteorTableField = function (name, type, params) {
    ...
    this.getInput = function () {
        ...
        switch (this.type) {
            case MeteorTableParams.METEOR_TABLE_FIELD_TYPE_TEXT:
...
MeteorTableParams.getSelectors = function (selector, filters, dataFilters, dateFormatMoment) {
        ...
        if (filter.type == MeteorTableParams.METEOR_TABLE_FIELD_TYPE_DATE) {
            ...
            if (value !== "") {
                ...
                _.each(value, function (curValue) {
                    if (curValue !== "") {
                        if (filter.type == MeteorTableParams.METEOR_TABLE_FIELD_TYPE_STRING || filter.type == MeteorTableParams.METEOR_TABLE_FIELD_TYPE_TEXT) {
                        ...
                        _.each(keys, function (key) {
                            var orelem = {};
                            if (filter.type == MeteorTableParams.METEOR_TABLE_FIELD_TYPE_SELECT) {
                                orelem[key] = curValue;
                            } else {
...
MeteorTableParams.getParams = function (fields, columnOrder, limit, skip, sort, sortOrder) {
