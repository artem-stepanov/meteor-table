    ...
    this.getInput = function () {
        ...
        switch (this.type) {
            ...
            case MeteorTable.FIELD_TYPE_SELECT:
                ...
                if (sortOptgroup) {
                    optgroup = _.sortBy(optgroup, function(options, key){
                        return _.indexOf(sortOptgroup, key);
                    });
                    var optgroupBySort = {};
                    _.each(optgroup, function (options, optgroupId) {
                        optgroupBySort[sortOptgroup[optgroupId]] = options;
                    });
